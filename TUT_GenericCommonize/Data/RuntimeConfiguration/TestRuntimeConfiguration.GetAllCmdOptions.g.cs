...
{
    [TestMethod]
    public void GetAllCmdOptionsTest_133_1()
    {
        using (ShimsContext.Create())
        {
            ...
            ;
            /* Act */
            String[] actualResult = (String[])typeof(RuntimeConfiguration).GetMethod("GetAllCmdOptions", BindingFlags.Instance | BindingFlags.Public, null, new Type[]{}, null).Invoke(_target, new object[]{});
            /* Assert */
    ...
    [TestMethod]
    public void GetAllCmdOptionsTest_133_2()
    {
        using (ShimsContext.Create())
        {
            /* Arrange */
