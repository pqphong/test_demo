...
{
    [TestMethod]
    public void GetContainersByDefName_Test_18_1()
    {
        using (ShimsContext.Create())
        {
            ...
            Renesas.Generator.MCALConfGen.Data.CDFData.Fakes.ShimRepositoryLinQ.AllInstances.getContainersByDefNameIListOfContainerStringInt32 = (RepositoryLinQ instance, IList<Container> containers, String _defName, Int32 _sortOption) =>
            {
            ...
            ;
            /* Act */
            IList<Container> actualResult = (IList<Container>)typeof(RepositoryLinQ).GetMethod("GetContainersByDefName", BindingFlags.Instance | BindingFlags.Public, null, new Type[]{typeof(String), typeof(String), typeof(Int32)}, null).Invoke(_target, new object[]{moduleName, defName, sortOption});
            /* Assert */
