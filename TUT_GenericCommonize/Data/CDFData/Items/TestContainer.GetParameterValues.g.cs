...
public partial class TestContainer
{
    ...
    public void GetParameterValuesTest_117_1()
    {
        using (ShimsContext.Create())
        {
            ...
            /* Act */
            IList<ItemValue> actualResult = (IList<ItemValue>)typeof(Container).GetMethod("GetParameterValues", BindingFlags.Instance | BindingFlags.Public, null, new Type[]{typeof(String)}, null).Invoke(_target, new object[]{paramName});
            /* Assert */
