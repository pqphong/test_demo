...
public partial class TestContainer
{
    ...
    public void GetChildsByDefNameTest_112_1()
    {
        using (ShimsContext.Create())
        {
            ...
            /* Act */
            IList<Container> actualResult = (IList<Container>)typeof(Container).GetMethod("GetChildsByDefName", BindingFlags.Instance | BindingFlags.Public, null, new Type[]{typeof(String), typeof(Int32), typeof(String)}, null).Invoke(_target, new object[]{defName, sortOption, variant });
            /* Assert */
    ...
    [TestMethod]
    public void GetChildsByDefNameTest_112_3()
    {
        using (ShimsContext.Create())
        {
            /* Arrange */
    ...
    [TestMethod]
    public void GetChildsByDefNameTest_112_4()
    {
        using (ShimsContext.Create())
        {
            /* Arrange */
