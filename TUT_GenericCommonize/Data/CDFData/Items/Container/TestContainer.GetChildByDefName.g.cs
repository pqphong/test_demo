...
public partial class TestContainer
{
    ...
    public void GetChildByDefNameTest_119_1()
    {
        using (ShimsContext.Create())
        {
            ...
            String variant = "";
            Renesas.Generator.MCALConfGen.Data.CDFData.Items.Fakes.ShimContainer.AllInstances.GetChildsByDefNameStringInt32String = (Container instance, String _defName, Int32 _sortOption, String variantID) =>
            {
            ...
            ;
            /* Act */
            Container actualResult = (Container)typeof(Container).GetMethod("GetChildByDefName", BindingFlags.Instance | BindingFlags.Public, null, new Type[]{typeof(String), typeof(Int32), typeof(String)}, null).Invoke(_target, new object[]{defName, sortOption, variant });
            /* Assert */
