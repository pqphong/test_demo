...
public partial class TestContainer
{
    ...
    public void GetReferenceValueTest_116_1()
    {
        using (ShimsContext.Create())
        {
            ...
            /* Act */
            ItemValue actualResult = (ItemValue)typeof(Container).GetMethod("GetReferenceValue", BindingFlags.Instance | BindingFlags.Public, null, new Type[] { typeof(String), typeof(String) }, null).Invoke(_target, new object[] { paramName, variantID });
            /* Assert */
    ...
    [TestMethod]
    public void GetReferenceValueTest_116_2()
    {
        using (ShimsContext.Create())
        {
            /* Arrange */
    ...
    [TestMethod]
    public void GetReferenceValueTest_116_3()
    {
        using (ShimsContext.Create())
        {
            /* Arrange */
    ...
    [TestMethod]
    public void GetReferenceValueTest_116_4()
    {
        using (ShimsContext.Create())
        {
            /* Arrange */
