...
public partial class TestRepositoryLinQ
{
    ...
    public void GetContainerTest_14_1()
    {
        using (ShimsContext.Create())
        {
            ...
            /* Act */
            Container actualResult = (Container)typeof(RepositoryLinQ).GetMethod("GetContainer", BindingFlags.Instance | BindingFlags.Public, null, new Type[]{typeof(String), typeof(String), typeof(String)}, null).Invoke(_target, new object[]{moduleName, shortName, variant});
            /* Assert */
    ...
    [TestMethod]
    public void GetContainerTest_14_3()
    {
        using (ShimsContext.Create())
        {
            /* Arrange */
    ...
    [TestMethod]
    public void GetContainerTest_14_4()
    {
        using (ShimsContext.Create())
        {
            /* Arrange */
    ...
    [TestMethod]
    public void GetContainerTest_14_5()
    {
        using (ShimsContext.Create())
        {
            /* Arrange */
