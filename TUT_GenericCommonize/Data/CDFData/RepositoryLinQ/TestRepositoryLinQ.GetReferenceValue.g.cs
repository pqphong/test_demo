...
public partial class TestRepositoryLinQ
{
    ...
    public void GetReferenceValueTest_8_1()
    {
        using (ShimsContext.Create())
        {
            ...
            /* Act */
            ItemValue actualResult = (ItemValue)typeof(RepositoryLinQ).GetMethod("GetReferenceValue", BindingFlags.Instance | BindingFlags.Public, null, new Type[]{typeof(String), typeof(String), typeof(String)}, null).Invoke(_target, new object[]{moduleName, defName, variant});
            /* Assert */
    ...
    [TestMethod]
    public void GetReferenceValueTest_8_3()
    {
        using (ShimsContext.Create())
        {
            /* Arrange */
