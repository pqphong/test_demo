...
public partial class TestRepositoryLinQ
{
    ...
    public void GetContainerByDefNameTest_27_1()
    {
        using (ShimsContext.Create())
        {
            ...
            Int32 sortOption = 0;
            string variant = "";
            Renesas.Generator.MCALConfGen.Data.CDFData.Fakes.ShimRepositoryLinQ.AllInstances.GetContainersByDefNameStringStringInt32String = (RepositoryLinQ instance, String _moduleName, String _defName, Int32 _sortOption, String variantID) =>
            {
            ...
            ;
            /* Act */
            Container actualResult = (Container)typeof(RepositoryLinQ).GetMethod("GetContainerByDefName", BindingFlags.Instance | BindingFlags.Public, null, new Type[]{typeof(String), typeof(String), typeof(Int32), typeof(String)}, null).Invoke(_target, new object[]{moduleName, defName, sortOption, variant });
            /* Assert */
