...
public partial class TestRepositoryLinQ
{
    ...
    public void getContainersByDefNameTest_4_1()
    {
        using (ShimsContext.Create())
        {
            ...
            /* Act */
            IList<Container> actualResult = (IList<Container>)typeof(RepositoryLinQ).GetMethod("getContainersByDefName", BindingFlags.Instance | BindingFlags.NonPublic, null, new Type[]{typeof(IList<Container>), typeof(String), typeof(Int32)}, null).Invoke(_target, new object[]{containers, defName, sortOption});
            /* Assert */
