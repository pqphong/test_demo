...
public partial class TestRepositoryLinQ
{
    ...
    public void GetParameterValueTest_17_1()
    {
        using (ShimsContext.Create())
        {
            ...
            Renesas.Generator.MCALConfGen.Data.CDFData.Fakes.ShimRepositoryLinQ.AllInstances.GetParameterValuesStringString = (RepositoryLinQ instance, String _moduleName, String _defName) =>
            {
            ...
            ;
            /* Act */
            ItemValue actualResult = (ItemValue)typeof(RepositoryLinQ).GetMethod("GetParameterValue", BindingFlags.Instance | BindingFlags.Public, null, new Type[]{typeof(String), typeof(String)}, null).Invoke(_target, new object[]{moduleName, defName});
            /* Assert */
