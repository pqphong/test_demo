...
public partial class TestRepositoryLinQ
{
    ...
    public void GetParameterValuesTest_10_1()
    {
        using (ShimsContext.Create())
        {
            ...
            /* Act */
            IList<ItemValue> actualResult = (IList<ItemValue>)typeof(RepositoryLinQ).GetMethod("GetParameterValues", BindingFlags.Instance | BindingFlags.Public, null, new Type[]{typeof(String), typeof(String)}, null).Invoke(_target, new object[]{moduleName, defName});
            /* Assert */
