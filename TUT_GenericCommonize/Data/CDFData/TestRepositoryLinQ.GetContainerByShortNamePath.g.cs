...
public partial class TestRepositoryLinQ
{
    ...
    public void GetContainerByShortNamePathTest_13_1()
    {
        using (ShimsContext.Create())
        {
            ...
            /* Act */
            Container actualResult = (Container)typeof(RepositoryLinQ).GetMethod("GetContainerByShortNamePath", BindingFlags.Instance | BindingFlags.Public, null, new Type[]{typeof(String), typeof(String)}, null).Invoke(_target, new object[]{moduleName, path});
            /* Assert */
