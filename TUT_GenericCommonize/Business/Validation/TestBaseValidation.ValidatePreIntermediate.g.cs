...
{
    [TestMethod]
    public void ValidatePreIntermediateTest_121_1()
    {
        using (ShimsContext.Create())
        {
            ...
            ;
            /* Act */
            typeof(BaseValidation).GetMethod("ValidatePreIntermediate", BindingFlags.Instance | BindingFlags.Public, null, new Type[]{}, null).Invoke(_target, new object[]{});
        /* Assert */
        }
    }
}