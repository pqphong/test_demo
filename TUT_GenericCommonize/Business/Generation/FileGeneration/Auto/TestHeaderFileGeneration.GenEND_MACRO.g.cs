...
{
    [TestMethod]
    public void GenEND_MACROTest_156_1()
    {
        using (ShimsContext.Create())
        {
            ...
            /* Act */
            BaseGenerationItem[] actualResult = (BaseGenerationItem[])typeof(HeaderFileGeneration).GetMethod("GenEND_MACRO", BindingFlags.Instance | BindingFlags.NonPublic, null, new Type[]{}, null).Invoke(_target, new object[]{});
            /* Assert */
            ...
            Assert.IsTrue( actualResult_0_11_value_22.ToString().Contains("#endif /* CANCFG_H */"));
        }
    }
}