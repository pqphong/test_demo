...
{
    [TestMethod]
    public void GenGLOBAL_DATA_TYPETest_160_1()
    {
        using (ShimsContext.Create())
        {
            /* Arrange */
            /* Act */
            BaseGenerationItem[] actualResult = (BaseGenerationItem[])typeof(HeaderFileGeneration).GetMethod("GenGLOBAL_DATA_TYPE", BindingFlags.Instance | BindingFlags.NonPublic, null, new Type[]{}, null).Invoke(_target, new object[]{});
            /* Assert */
