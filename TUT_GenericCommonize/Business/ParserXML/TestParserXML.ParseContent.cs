...
{
    [TestMethod]
    public void parseContentTest_16_1()
    {
        using (ShimsContext.Create())
        {
            ...
            String string135 = "IMPLEMENT-";
            String name = string135;
            /* Act */
            typeof(ParserXML).GetMethod("parseContent", BindingFlags.Instance | BindingFlags.NonPublic, null, new Type[]{typeof(XElement), typeof(String[]), typeof(Dictionary<String, String>), typeof(String), typeof(BswConfig).MakeByRefType()}, null).Invoke(_target, new object[]{ BSW_IMPLEMENTATION, requiredFields, tagNameToField, name, bswConfig});
            /* Assert */
    ...
    [TestMethod]
    public void parseContentTest_16_2()
    {
        using (ShimsContext.Create())
        {
            // document
            ...
            BswConfig bswconfig124 = new BswConfig();
            BswConfig bswConfig = bswconfig124;
            String string135 = "DESCRIPTION-";
            String name = string135;
            /* Act */
            typeof(ParserXML).GetMethod("parseContent", BindingFlags.Instance | BindingFlags.NonPublic, null, new Type[] { typeof(XElement), typeof(String[]), typeof(Dictionary<String, String>), typeof(String) ,typeof(BswConfig).MakeByRefType()}, null).Invoke(_target, new object[] { BSW_MODULE_DESCRIPTION, requiredFields, tagNameToField,name, bswConfig });
            /* Assert */
            Assert.AreEqual(bswconfig124.ModuleId, "82");
            Assert.AreEqual(bswconfig124.DescriptionShortName, "LinInternalBehavior");
           
        }
    }

    [TestMethod]
    public void parseContentTest_16_3()
    {
        using (ShimsContext.Create())
        {
            // document
            ...
            String name = string135;
            /* Act */
            typeof(ParserXML).GetMethod("parseContent", BindingFlags.Instance | BindingFlags.NonPublic, null, new Type[] { typeof(XElement), typeof(String[]), typeof(Dictionary<String, String>),  typeof(String), typeof(BswConfig).MakeByRefType()}, null).Invoke(_target, new object[] { document, requiredFields, tagNameToField, name, bswConfig });
            /* Assert */
            Assert.AreEqual(bswConfig.DescriptionShortName, null);
            Assert.AreEqual(bswConfig.BehaviorRef, null);
            Assert.AreEqual(bswConfig.ArReleaseVersion, null);
