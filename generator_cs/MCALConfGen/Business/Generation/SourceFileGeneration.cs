...
/* Module       = SourceFileGeneration.cs                                                                             */
/* Version      = 2.3.0                                                                                               */
/* Date         = 31/01/2025                                                                                          */
/*====================================================================================================================*/
/*                                  COPYRIGHT                                                                         */
...
/*====================================================================================================================*/
/* Purpose: This file contains SourceFileGeneration an abstract class for classes used to generate .c file.           */
/*                                                                                                                    */
/*====================================================================================================================*/
/*                                                                                                                    */
...
/* 1.2.1:     02/07/2021 :    Update method GenINSTANCE_INDEX                                                         */
/*            10/07/2021 :    Update constructor argument in method GenINSTANCE_INDEX                                 */
...
{
    /// <summary>
    /// "SourceFileGeneration" an abstract class for classes used to generate .c file.
    /// </summary>
    public abstract class SourceFileGeneration : FileGeneration
    {

        /// <summary>
        /// Source file generation constructor
        /// </summary>
        ...
        /// Init component
        /// </algorithm>
        protected SourceFileGeneration
        (
            string fileName,
        ...
        // Implementation: GENERIC_TUD_CLS_022_007

        /// <summary>
        /// Generate version checking
        /// </summary>
        /// <returns>
        ///     <para>BaseGenerationItem[]
        ///         <desc>BaseGenerationItem of version checking</desc>
        ///         <range>Null</range>
        ///     </para>
        /// </returns>
        /// <generated_value>
        ...
        /// </generated_value>
        /// <algorithm>
        /// Generate version check. An abstract method overrided by specific module
        /// to provide version checking information
        /// </algorithm>
        [ItemGeneration(Section = ItemGenerationAttribute.SectionName.VERSION_CHECK)]
        protected virtual BaseGenerationItem[] GenVERSION_CHECK()
        {
            return null;
        }
        // Implementation: GENERIC_TUD_CLS_022_006
        ...
        /// <returns>
        ///     <para>BaseGenerationItem[]
        ///         <desc>BaseGenerationItem of instance index</desc>
        ...
        /// Generate instance index
        /// </algorithm>
        [ItemGeneration(Section = ItemGenerationAttribute.SectionName.INSTANCE_INDEX)]
        protected virtual BaseGenerationItem[] GenINSTANCE_INDEX()
        {
            // Ignore if multi instance is not used.
            if (BasicConfiguration.HasInstanceSetting)
            {
                string moduleName = BasicConfiguration.ModuleName.ToUpper();

                string defineName = String.Format("{0}_{1}", moduleName, Constant.INSTANCE_INDEX);

                return new BaseGenerationItem[] {
                new DefineGenerationItem (
                    String.Empty,
                    String.Empty,
                    null,
                    defineName,
                    BasicConfiguration.InstanceIndex.ToString(),
                    hasNameInstanceSetting:false
                    )
                };
            }
            else
        ...
        // Implementation: GENERIC_TUD_CLS_022_004

        /// <summary>
        /// Generate global data type
        /// </summary>
        /// <returns>
        ///     <para>BaseGenerationItem[]
        ///         <desc>BaseGenerationItem of global data type</desc>
        ///         <range>Null</range>
        ///     </para>
        /// </returns>
        /// <generated_value>
        ...
        /// </generated_value>
        /// <algorithm>
        /// Generate global data type. An abstract method overrided by specific module
        /// to provide global data type information
        /// </algorithm>
        ...
        // Implementation: GENERIC_TUD_CLS_022_003
        ...
        // Implementation: GENERIC_TUD_CLS_022_002
        ...
        /// <returns>
        ///     <para>BaseGenerationItem[]
        ///         <desc>BaseGenerationItem of function definitions</desc>
        ///         <range>Null</range>
        ///     </para>
        /// </returns>
        /// <generated_value>
        ...
        /// </generated_value>
        /// <algorithm>
        /// Generate function definitions. An abstract method overrided by specific module
        /// to provide function definitions information
        /// </algorithm>
        [ItemGeneration(Section = ItemGenerationAttribute.SectionName.FUNTION_DEFINE)]
        protected virtual BaseGenerationItem[] GenFUNTION_DEFINE()
        {
            return null;
        }
        // Implementation: GENERIC_TUD_CLS_022_001
        ...
        // Implementation: GENERIC_TUD_CLS_022_005
    }
}
