...
/*====================================================================================================================*/
/* Purpose: This file contains ICommandLine interface that defines methods need to be implemented by a command line.  */
/*                                                                                                                    */
/*====================================================================================================================*/
/*                                                                                                                    */
...
/*              Devices:       X2x                                                                                    */
/*====================================================================================================================*/
/* Classes      : This file contains the following interface ICommandLine                                             */
/*                                                                                                                    */
/*====================================================================================================================*/
/*====================================================================================================================*/
/* Version History:                                                                                                   */
...
{
    /// <summary>
    /// ICommandLine interface that defines methods need to be implemented by a command line.
    /// </summary>
    public interface ICommandLine
    {
        string GetAndValidateModuleName();
        void ProcessCommandLine();
        void PrintToolInfo();
        void DisplayCmdInformation();
    }
}
